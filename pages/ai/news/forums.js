...
import ForumsList from '../../../components/ai/news/forums/ForumsList'

import rssList from '../../../components/ai/news/forums/rssList'
import keywords from '../../../components/ai/keywords'
import Parser from 'rss-parser'

const Forums = ({ data }) => {
  const meta = {
    title: 'HelloPython AI | Forums',
    description:
...
export async function getServerSideProps() {
  ...
  const data = await getMoreForums()
